    ...
    internal static unsafe class __interpreter
    {
        ...
        internal static void ExecuteBytecode(byte[] instructions, int argOffset = 0, int localOffset = 0)
        {
            ...
            fixed(byte* instructionPtr  = instructions)
            {
                ...
                // Run bytecode
                ExecuteBytecode(argPtr, localPtr, stackPtr, instructionPtr);
            }
        }

        internal static void ExecuteBytecode(byte* argPtr, byte* localPtr, byte* stackPtr, byte* instructionPtr)
        {
            bool halt = false;
