...
namespace CompilerTests.AST.ParseGenerateSource.FromSyntax
{
    ...
    public sealed class SyntaxGenerateStatementUnitTests
    {
        ...
        {
            SyntaxNode syntax0 = Syntax.LocalVariable(Syntax.TypeReference(PrimitiveType.I32), "var")
                .NormalizeWhitespace();
            ...
            SyntaxNode syntax2 = Syntax.LocalVariable(Syntax.TypeReference("MyType"), "var", Syntax.VariableAssignment(Syntax.Literal(5)))
                .NormalizeWhitespace();
            ...
            SyntaxNode syntax3 = Syntax.LocalVariable(Syntax.TypeReference("MyType"), new SyntaxToken[] { "var1", "var2" }, Syntax.VariableAssignment(Syntax.Literal(5), Syntax.Literal(10)))
                .NormalizeWhitespace();
