    ...
    public sealed class EmitBinaryInstructionsUnitTests
    {
        ...
        public void EmitBinary_Equal_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Equal, Syntax.Literal(2))))));
        ...
        public void EmitBinary_NotEqual_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.NotEqual, Syntax.Literal(2))))));
        ...
        public void EmitBinary_Sub_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Subtract, Syntax.Literal(2))))));
        ...
        public void EmitBinary_Mul_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Multiply, Syntax.Literal(2))))));
        ...
        public void EmitBinary_Div_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Divide, Syntax.Literal(2))))));
        ...
        public void EmitBinary_Greater_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Greater, Syntax.Literal(2))))));
        ...
        public void EmitBinary_GreaterEqual_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.GreaterEqual, Syntax.Literal(2))))));
        ...
        public void EmitBinary_Less_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.Less, Syntax.Literal(2))))));
        ...
        public void EmitBinary_LessEqual_I32_I32()
        {
            SyntaxTree tree = SyntaxTree.Create(
                ...
                Syntax.Method("Test")
                .WithStatements(Syntax.Variable(Syntax.TypeReference(PrimitiveType.Any), "myVar"),
                    Syntax.Assign(Syntax.VariableReference("myVar"), Syntax.Binary(Syntax.Literal(5), BinaryOperation.LessEqual, Syntax.Literal(2))))));
